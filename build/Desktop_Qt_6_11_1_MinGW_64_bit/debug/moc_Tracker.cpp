...
template <> constexpr inline auto Tracker::qt_create_metaobjectdata<qt_meta_tag_ZN7TrackerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(cv::Mat, cv::Mat)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void Tracker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->frameProcessed((*reinterpret_cast<std::add_pointer_t<cv::Mat>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<cv::Mat>>(_a[2]))); break;
        case 1: _t->GetFrame((*reinterpret_cast<std::add_pointer_t<cv::Mat>>(_a[1]))); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Tracker::*)(cv::Mat , cv::Mat )>(_a, &Tracker::frameProcessed, 0))
            return;
    }
}
...
// SIGNAL 0
void Tracker::frameProcessed(cv::Mat _t1, cv::Mat _t2)
{
